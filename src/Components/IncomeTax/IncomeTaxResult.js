        ...
        <>
            {jsonData.TYPE == "INCOME_TAX" ?
                <>
                    ...
                    <div style={{paddingTop: "26px", marginLeft: "60px", fontSize: "18px", color: "white"}}>
                        과세 소득 : {formatterNumber(String(jsonData.TAX_AMT))}원 = ({formatterNumber(String(jsonData.PAY_AMT))}원(세전 월 급여)) - {formatterNumber(String(jsonData.NONTAX_AMT))}원(비과세 금액)
                    </div>
                    {
