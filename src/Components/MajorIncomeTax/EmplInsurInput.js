...
function InputComponent({ calculator, changeData, setChangeData }) {
    ...
    const calEventHandler = e => {
        ...
        json_data["TYPE"] = "EmplInsur";
        json_data["AMT"] = amtHandler;
        json_data["TAX_AMT"] = parseInt(amtHandler.replaceAll(",", ""));
        json_data["RESULT_AMT"] = parseInt(amtHandler.replaceAll(",", "")) * 0.8 / 100;
        json_data["RESULT_AMT2"] = delAmt0(parseInt(amtHandler.replaceAll(",", "")) * 0.8 / 100);
